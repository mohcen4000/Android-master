...
public class Temperature extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save=findViewById(R.id.btn_temp);
        title=findViewById(R.id.title_temp);
        content_title=findViewById(R.id.content_title_temp);
       ...
       // Patient p= (Patient) i.getSerializableExtra("p");
        ...
        inputBirthDate=findViewById(R.id.date_temp);

        psaback=findViewById(R.id.temp_back_first);

        temp=findViewById(R.id.temp_ed);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isOld==true)
                {
                    ...
                    addPressure(idp,temp.getText().toString(),Register.toMysqlDate(sdf.format(myCalendar.getTime())));
                }
                else{
                    addPressure(idp,temp.getText().toString(),Register.toMysqlDate(date));
                }
                finish();
            }
        });
        ...
        inputBirthDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(Temperature.this, date, myCalendar
    ...
    private void addPressure(int id,String temp,String adate) {
        /*

        StringRequest stringRequest = new StringRequest(
                Request.Method.POST,
                Constants.URL_UPDATE_TEMP,
    ...
    public void getPhy(int id,String date){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, uri,
                        ...
                        try {
                            ...
                            for (int i = 0; i<array.length(); i++){
                                ...
                                if(pdpressure!="")
                                {
                                    ...
                                    title.setText("Update Temperature");
                                    content_title.setText("Update your Temperature");
                                }
                                else
                                {
                                    title.setText("Add Temperature");
                                    content_title.setText("Add your Temperature");
                                }
                                ...
                                temp.setText(physicalData.getTemp());
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                //progressBar.setVisibility(View.GONE);
                Toast.makeText(Temperature.this, error.toString(),Toast.LENGTH_LONG).show();

            }
        });

        Volley.newRequestQueue(Temperature.this).add(stringRequest);
